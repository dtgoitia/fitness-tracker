import { useApp } from ".";
import { ActivitiesStatsPage } from "./pages/ActivitiesStats";
...
import { TrainablesStatsPage } from "./pages/TrainablesStats";
...
export function AppUI() {
  ...
  return (
    <Routes>
      ...
      <Route path={Paths.activityStats} element={<ActivitiesStatsPage />} />
      <Route path={Paths.trainableStats} element={<TrainablesStatsPage />} />
